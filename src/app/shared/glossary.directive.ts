...
export class GlossaryDirective {
 ...
 private testGlossary = [                         
                        ...
                        {term: 'DT', definition: 'Developmental Test(s)'},
                        ...
                        {term: 'JQR', definition: 'Job Qualification Requirement(s)'},
                        {term: 'KPP', definition: 'Key Performance Parameter'},
                        {term: 'KSA(s)', definition: 'Knowledge, Skills, and Abilities; Key System Attribute'},
                        ...
                        {term: 'OT', definition: 'Operational Test(s)'},
                        ...
                        {term: 'PQS', definition: 'Personnel Qualification Standard(s)'},
